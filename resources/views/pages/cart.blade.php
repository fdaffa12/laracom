                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="shoping__cart__item">
                                        <img src="{{asset($cart->product->image_one)}}" alt="" style="height: 70px; width: 70px;">
                ...
                <div class="col-lg-6">
                    <div class="shoping__checkout">
                        ...
                        <ul>
                            ...
                            <li>Discount <span>{{session()->get('coupon')['coupon_discount']}}% (Rp. {{ session()->get('coupon')['coupon_discount'] }} )</span></li>
                            <li>Total <span>Rp. {{ $subtotal - session()->get('coupon')['discount_amount'] }}</span></li>
                            @else
                            <li>Subtotal <span>Rp. {{$subtotal}}</span></li>
                            @endif
                        </ul>
