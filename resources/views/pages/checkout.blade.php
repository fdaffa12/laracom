                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <div class="checkout__order__subtotal">Total <span>Rp. {{ $subtotal - session()->get('coupon')['discount_amount'] }}</span></div>
                                ...
                                @else
                                <div class="checkout__order__total">Subtotal <span>Rp. {{$subtotal}}</span></div>
                                <input type="hidden" name="subtotal" value="{{$subtotal}}">
